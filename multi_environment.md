...
where **Z**<sub>e</sub> is the design matrix for the effects of environments. The reaction norm model, incorporates GxE by introducing the interaction terms  
